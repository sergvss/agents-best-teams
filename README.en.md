...
**Why it is not all translated.** Around 5,600 lines of prose that changes every release. A second copy would drift from the first, and a role template that quietly disagrees with its Russian original is more dangerous than a missing one — you would be running rules you cannot verify. A translation needs a maintainer who keeps it honest, not a one-off pass.
