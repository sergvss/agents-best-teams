...
Последний пункт здесь не обещание, а работающий код: `hooks/guard.py` с 43 тестами, половина из которых проверяет отсутствие ложных срабатываний.
...
```
principles/    10 принципов: философия, Tier-декомпозиция, классы риска,
               бюджеты, триангуляция, память, stop rules, approval log,
               механические инварианты, eval-suite
...
hooks/         Рабочие защитные хуки — слой Claude Code
               guard.py, конфигурации, 43 теста
